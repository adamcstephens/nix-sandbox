# https://github.com/malloc47/config/blob/047fa95ce77e177e6c7c8d33ef8ca914605b9deb/pkgs/cljfmt/default.nix
{
  lib,
  stdenv,
  fetchFromGitHub,
  ...
  src =
    fetchFromGitHub {
      ...
      hash = "sha256-IuKWmaSFbeCxc83bpxRJ08Ks2etFhc4OgO9TKQhE1TA=";
    }
    + "/cljfmt";
  ...
  deps = stdenv.mkDerivation {
    ...
    outputHash = "sha256-IUg3KUDlamhi/3mJb7SqnuqR5CVeuxRH4DsO3aBQnNw=";
  };
in
